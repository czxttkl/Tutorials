...
parser.add_argument('--vaelogdir', type=str, help='Directory where results are logged',
                    default='output_models')
parser.add_argument('--datadir', type=str, help='Directory where training data are logged',
...
dataset_train = RolloutObservationDataset(
    ...
    train_size=60,
    train=True)
dataset_test = RolloutObservationDataset(
    root=args.datadir,
...
vae_dir = join(args.vaelogdir, 'vae')
