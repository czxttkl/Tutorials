...
class DQNCartPoleSolver():
    def __init__(self, n_episodes=20000, n_win_ticks=195, max_env_steps=None, gamma=1.0, epsilon=1.0, epsilon_min=0.01,
        ...
        self.model.add(Dense(24, input_dim=self.env.observation_space.shape[0], activation='tanh'))
